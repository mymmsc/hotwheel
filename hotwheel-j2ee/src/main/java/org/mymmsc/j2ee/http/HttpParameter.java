 ...
 * @see <url>http://wakan.blog.51cto.com/59583/7209</url>
 * @since mymmsc-j2ee 6.3.9
 */
public class HttpParameter {
    private static Logger logger = LoggerFactory.getLogger(HttpParameter.class);
     ...
     * HttpParameter构造函数
     *
     * @param enc_app  应用程序编码格式
     * @param enc_data 数据编码格式
     */
    ...
    private void parse(int paramcount) throws IOException {
        ...
        if (request.getContentType().indexOf("form-data") > 0) {
            ...
            tmpQuery = URLDecoder.decode(tmpQuery, m_encData);
