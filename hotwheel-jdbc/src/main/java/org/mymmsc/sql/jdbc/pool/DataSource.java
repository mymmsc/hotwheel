 ...
 * @version 1.0
 */
public class DataSource extends DataSourceProxy implements javax.sql.DataSource,MBeanRegistration, ConnectionPoolMBean, javax.sql.ConnectionPoolDataSource {
...
//===============================================================================
//  JMX Operations - Register the actual pool itself under the mymmsc.jdbc domain
//===============================================================================
    ...
    public ObjectName createObjectName(ObjectName original) throws MalformedObjectNameException {
        ...
        if (original.getKeyProperty("path")!=null || properties.get("context")!=null) {
            //this ensures that if the registration came from mymmsc, we're not losing
