...
public class PooledConnection {
     ...
     * @throws SQLException if a call to {@link java.sql.Driver#connect(String, Properties)} fails.
    ...
    protected void connectUsingDriver() throws SQLException {
        ...
        try {
            ...
            if (parent.jmxPool!=null) {
                parent.jmxPool.notify(org.mymmsc.sql.jdbc.pool.jmx.ConnectionPool.NOTIFY_CONNECT,
...
//============================================================================
     ...
     * This timestamp can also be reset by the {@link ResetAbandonedTimer#invoke(Object, java.lang.reflect.Method, Object[])}
     ...
     * ie, a successful call to {@link java.sql.Driver#connect(String, Properties)}.
