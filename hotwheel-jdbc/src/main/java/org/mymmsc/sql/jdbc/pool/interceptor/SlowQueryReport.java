...
public class SlowQueryReport extends AbstractQueryReport  {
    //logger
    private static final Logger log = LoggerFactory.getLogger(SlowQueryReport.class);
    ...
    public static class QueryStats {
        ...
        public String toString() {
            ...
            buf.append(sdf.format(new Date(maxInvocationDate)));
            buf.append(", minInvocationTime:");
            buf.append(minInvocationTime);
            buf.append(", minInvocationDate:");
            buf.append(sdf.format(new Date(minInvocationDate)));
