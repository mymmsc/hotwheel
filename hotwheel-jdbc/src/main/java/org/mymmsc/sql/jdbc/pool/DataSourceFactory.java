...
public class DataSourceFactory implements ObjectFactory {
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx,
        ...
        if (org.mymmsc.sql.jdbc.pool.DataSource.class.getName().equals(ref.getClassName())) {
            ok = true;
        }
    ...
    public DataSource createDataSource(Properties properties,Context context, boolean XA) throws Exception {
        ...
        org.mymmsc.sql.jdbc.pool.DataSource dataSource = XA?
                new XADataSource(poolProperties) :
                new org.mymmsc.sql.jdbc.pool.DataSource(poolProperties);
