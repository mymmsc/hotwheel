 ...
 */
package org.mymmsc.sql.jdbc.pool.jmx;
/**
 * @author Filip Hanik
 */

import org.mymmsc.sql.jdbc.pool.PoolConfiguration;
import org.mymmsc.sql.jdbc.pool.PoolProperties.InterceptorDefinition;
import org.mymmsc.sql.jdbc.pool.PoolUtilities;
import org.mymmsc.sql.jdbc.pool.Validator;
...
public class ConnectionPool extends NotificationBroadcasterSupport implements ConnectionPoolMBean  {
     ...
     * the connection pool
     */
    protected org.mymmsc.sql.jdbc.pool.ConnectionPool pool = null;
    /**
    ...
    public ConnectionPool(org.mymmsc.sql.jdbc.pool.ConnectionPool pool) {
        super();
        this.pool = pool;
    }

    public org.mymmsc.sql.jdbc.pool.ConnectionPool getPool() {
        return pool;
    }
