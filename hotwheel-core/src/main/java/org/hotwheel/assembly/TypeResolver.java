...
public final class TypeResolver {
     ...
     * @return type argument for {@code type} else {@code subType} if no type arguments are
     * declared
     ...
     * @param subType     to extract type variable information from
     * @return type argument for {@code genericType} else {@code subType} if no type arguments
     * are declared
     * @throws IllegalArgumentException if more or less than one type argument is resolved for the
     *                                  {@code genericType}
     */
