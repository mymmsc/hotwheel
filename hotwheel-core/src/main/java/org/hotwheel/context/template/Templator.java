...
public class Templator {
     ...
     * @throws VariableNotDefinedException when no variable with the specified name exists in the
     ...
     * @param isOptional specifies whether an exception should be thrown when the block
     ...
     *
     * @param outputFileName name of the file to which the generated HTML page will be
     *                       written.
     ...
     *
     * @param outputWriter a character stream (<code>writer</code>) to which the HTML
