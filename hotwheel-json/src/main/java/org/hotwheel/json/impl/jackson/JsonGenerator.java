...
//  @Override
     ...
     * ({@link org.hotwheel.json.impl.jackson.DefaultPrettyPrinter}).
     *
     * @return Generator itself (this), to allow chaining
     */
     ...
     * linefeeds. However, all {@link JacksonParser} implementations
     ...
     */
    public abstract void copyCurrentEvent(JacksonParser jp)
            throws IOException, JsonProcessingException;
     ...
     */
    public abstract void copyCurrentStructure(JacksonParser jp)
            throws IOException, JsonProcessingException;
