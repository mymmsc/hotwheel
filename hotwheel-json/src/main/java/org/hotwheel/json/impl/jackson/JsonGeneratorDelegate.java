...
public class JsonGeneratorDelegate extends JsonGenerator {
    ...
    @Override
    public void copyCurrentEvent(JacksonParser jp) throws IOException, JsonProcessingException {
        delegate.copyCurrentEvent(jp);
    }

    @Override
    public void copyCurrentStructure(JacksonParser jp) throws IOException, JsonProcessingException {
